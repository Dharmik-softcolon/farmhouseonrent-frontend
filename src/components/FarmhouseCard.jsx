    ...
    return (
        <div className="card group cursor-pointer">
            <Link to={`/farmhouse/${slug || _id}`}>
                ...
                {/* Content */}
                <div className="p-4">
                    <h3 className={`font-bold text-gray-900 mb-1 line-clamp-1 group-hover:text-primary-600 transition-colors ${compact ? 'text-sm' : 'text-base'}`}>
                        {title}
                    </h3>
                    ...
                    {/* Facilities Preview — hide in compact mode */}
                    {!compact && (
